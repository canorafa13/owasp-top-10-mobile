    ...
    val appSignatures: ArrayList<String>
        get() {
            ...
            try {
                ...
                Logger.show(message = "Unable to find package to obtain hash.")
            }
            return appCodes
        }
    ...
    companion object {
        ...
        private fun hash(packageName: String, signature: String): String? {
            ...
            try {
                ...
                Logger.show(message = String.format("pkg: %s -- hash: %s", packageName, base64Hash))
                return base64Hash
            } catch (e: NoSuchAlgorithmException) {
                Logger.show(message = "hash:NoSuchAlgorithm")
            }
            return null
        }
    }
